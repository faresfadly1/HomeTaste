...
const routes = ["orders", "browse", "dishes", "favorites", "messages", "become", "help", "settings"];
const required = [
  "index.html",
  "404.html",
  "app.js",
...
for (const route of routes) {
  ...
  if (!routeHtml.includes(expected)) fail(`public/${route}/index.html does not route to ${expected}`);
}
